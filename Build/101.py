#Q:Write a Python program to find the name of the oldest student in a given dictionary containing the names and ages of a group of students.

def oldest_student(student):
    return max(student, key=student.get)
